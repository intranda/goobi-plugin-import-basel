...
public abstract class AbstractCatalogueImportPlugin implements IImportPlugin {
    ...
    public Fileformat convertData() throws ImportPluginException {
        fileformat = null;
        ConfigOpacCatalogue coc = ConfigOpac.getInstance().getCatalogueByName(getTitle());
        if (opacPlugin == null) {

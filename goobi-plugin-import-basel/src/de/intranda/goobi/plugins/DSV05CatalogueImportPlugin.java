...
public class DSV05CatalogueImportPlugin implements IImportPlugin, IPlugin {

    private static final String name = "DSV05";
    ...
    public DSV05CatalogueImportPlugin() {
    ...
    public Fileformat convertData() throws ImportPluginException {
        fileformat = null;
        ConfigOpacCatalogue coc = ConfigOpac.getInstance().getCatalogueByName("DSV05");
